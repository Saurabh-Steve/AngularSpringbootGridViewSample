package com.thales.widgets

import android.content.Context
import android.graphics.Typeface
import android.util.AttributeSet

class PingFangTextView : androidx.appcompat.widget.AppCompatTextView {
    ...
    private fun setup() {
        typeface = Typeface.createFromAsset( context.assets, "font/PingFang.SC.Regular.ttf" );
    }
}